...
public function executor(string argument, map<isolated function (caller:InputFunc func) returns any|error> serverMapper) returns validator:Error|validator:Response|BatchResponse|error?{
